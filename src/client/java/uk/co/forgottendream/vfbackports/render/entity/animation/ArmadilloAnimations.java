package uk.co.forgottendream.vfbackports.render.entity.animation;
...
public class ArmadilloAnimations {
    ...
    static {
        ROLLING = Animation.Builder.create(0.5F)
                ...
                .build();
        IDLE = Animation.Builder.create(1.4583F).looping()
                .addBoneAnimation("body", new Transformation(Transformation.Targets.ROTATE,
                ...
                .addBoneAnimation("head", new Transformation(Transformation.Targets.ROTATE,
                        ...
                        new Keyframe(1.4583F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR)))
                .build();
        SCARED = Animation.Builder.create(2.5F)
                .addBoneAnimation("head", new Transformation(Transformation.Targets.ROTATE,
                ...
                .build();
        UNROLLING = Animation.Builder.create(1.5F)
                .addBoneAnimation("head", new Transformation(Transformation.Targets.ROTATE,
